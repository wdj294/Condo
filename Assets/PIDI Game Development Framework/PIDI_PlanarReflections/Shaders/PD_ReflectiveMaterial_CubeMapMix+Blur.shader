//
// PD_ReflectiveMaterial_CubeMapMix+Blur.shader
...
Shader "PIDI Shaders Collection/Planar Reflection/Generic/Cubemap Mix + Blur" {
	Properties {
		[Space(12)]
		...
		[Space(8)]
		_EmissionColor( "Emission Color (RGB) Intensity (Alpha)", Color ) = (1,1,1,0.5)
	...
	SubShader {
		...
		void surf (Input IN, inout SurfaceOutputStandardSpecular o) {
			...
			o.Smoothness = _Glossiness*gsoh.r; //Glossiness value is multiplied by the red channel of our GSOH texture
