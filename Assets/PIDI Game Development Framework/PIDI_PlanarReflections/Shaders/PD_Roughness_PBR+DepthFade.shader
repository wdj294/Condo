Shader "PIDI Shaders Collection/Planar Reflection/PBR/Roughness Setup+Depth Fade" {
	...
	SubShader {
		...
		void surf (Input IN, inout SurfaceOutputStandard o) {
			...
			float rDepth = length(tex2Dproj( _ReflectionDepth, UNITY_PROJ_COORD( IN.screenPos ) ).rgb)*(1-o.Smoothness);
